...
class Face_Register:
    def __init__(self):
        ...
        self.path_photos_from_camera = "E:\python-venv\Face-Recognition-Based-Attendance-System-main\data\data_faces_from_camera/"
    ...
    def GUI_info(self):
        ...
        tk.Button(self.frame_right_info,
                  text='Back',
                  command=self.backtomain).grid(row=12, column=0, columnspan=3, sticky=tk.W)
    ...
    def check_existing_faces_cnt(self):
        if os.listdir("E:\python-venv\Face-Recognition-Based-Attendance-System-main\data\data_faces_from_camera/"):
            # Get the order of latest person
            person_list = os.listdir("E:\python-venv\Face-Recognition-Based-Attendance-System-main\data\data_faces_from_camera/")
            person_num_list = []
...
def main():
    ...
    features_extraction_to_csv.main() # Extract features and save to csv
